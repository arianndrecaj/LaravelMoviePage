...
<div class="col-md-6 offset-md-3">
    ...
    <div class="card card-outline-secondary">
        <div class="card-body">
            ...
            <hr>
            <form class="form" action="" role="form" autocomplete="off">
                ...
                <div class="form-inline">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control text-right" value="40$" disabled>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <a href="{{route('plan')}}" onclick="show()" class="btn btn-primary">Submit</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script>
        function show() {
            alert('Successful payment! Enjoy premium.');
